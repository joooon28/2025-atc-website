...
export default function Main() {
  return (
    <main className="min-h-svh bg-mint-3">
      ...
      <div className="font-mono max-[800px]:hidden fixed inset-x-0 bottom-0 flex justify-between items-end px-5 pb-[40px] pointer-events-none">
      ...
      <p className="fixed min-[800px]:hidden left-0 right-0 top-[165px] opacity-80 font-mono text-center line-height-[1.4] text-label/30 ">
        2025 <br />
